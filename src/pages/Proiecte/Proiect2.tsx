...
import Img3 from "../../assets/IasiOutdoor3.jpeg";
import Img4 from "../../assets/IasiOutdoor4.jpeg";
        ...
        >
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-white">
              Monarch Mansion Galați
            </h1>

            <p className="mt-4 max-w-2xl text-white/70">
              Proiectul a pus accent pe conturarea volumelor și evidențierea elementelor decorative printr-un sistem de iluminat arhitectural atent poziționat. Rezultatul este o fațadă care capătă profunzime și personalitate.
