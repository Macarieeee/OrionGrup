...
const entries: TranslationEntry[] = [
  { ro: "Acasă", en: "Home", aliases: ["Home", "Acasa"] },
  ...
  { ro: "Portofoliul Nostru", en: "Our Portfolio" },
  {
    ...
    aliases: [
      "O scurtÄƒ previzualizare a efectului serviciilor È™i produselor noastre de Ã®naltÄƒ calitate",
      "O scurta previzualizare a efectului serviciilor si produselor noastre de inalta calitate",
    ],
  },
  { ro: "Se incarca proiectele...", en: "Loading projects..." },
  { ro: "Nu am putut incarca proiectele:", en: "Could not load projects:" },
  { ro: "Nu exista proiecte disponibile momentan.", en: "There are no projects available at the moment." },
  { ro: "Despre Noi", en: "About Us" },
  {
  ...
  { ro: "Termeni si conditii", en: "Terms and Conditions" },
  { ro: "Politica de confidentialitate", en: "Privacy Policy" },
  { ro: "Cont client si newsletter", en: "Client Account and Newsletter" },
  { ro: "Cerere oferta", en: "Quote Request" },
  { ro: "Aboneaza-te", en: "Subscribe" },
  { ro: "Inapoi la site", en: "Back to Website" },
  ...
  { ro: "6. Abonarea la newsletter", en: "6. Newsletter Subscription" },
  { ro: "7. Trimiterea emailurilor prin servicii terțe", en: "7. Sending Emails Through Third-Party Services" },
  { ro: "8. Confirmarea către utilizator", en: "8. User Confirmation" },
  { ro: "9. Obligațiile utilizatorului", en: "9. User Obligations" },
  { ro: "10. Securitate și limitări tehnice", en: "10. Security and Technical Limitations" },
  { ro: "11. Păstrarea datelor", en: "11. Data Retention" },
  { ro: "12. Drepturile utilizatorului", en: "12. User Rights" },
  { ro: "13. Modificarea termenilor", en: "13. Changes to These Terms" },
  { ro: "1. Date prelucrate", en: "1. Processed Data" },
  { ro: "2. Scopuri", en: "2. Purposes" },
  { ro: "3. Newsletter", en: "3. Newsletter" },
  { ro: "4. Servicii tehnice", en: "4. Technical Services" },
  { ro: "5. Pastrarea datelor", en: "5. Data Retention" },
  { ro: "6. Drepturile utilizatorilor", en: "6. User Rights" },
  {
