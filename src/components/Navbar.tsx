      ...
      <div ref={barRef} className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3">
        ...
        >
          ...
          <nav className="relative z-10 ml-2 hidden md:flex items-center gap-6 text-sm text-white/70">
            <a className="hover:text-white transition" href="#features">Home</a>
            <a className="hover:text-white transition" href="#company">Shop</a>
            <a className="hover:text-white transition" href="#blog">Portfolio</a>
            <a className="hover:text-white transition" href="#shop">About Us</a>
          </nav>
          ...
          {open && (
            ...
            >
              <div className="flex flex-col text-white/85 text-sm">
                <a onClick={() => setOpen(false)} className="rounded-lg px-3 py-2 hover:bg-white/10" href="#features">Home</a>
                <a onClick={() => setOpen(false)} className="rounded-lg px-3 py-2 hover:bg-white/10" href="#company">Shop</a>
                <a onClick={() => setOpen(false)} className="rounded-lg px-3 py-2 hover:bg-white/10" href="#blog">Portfolio</a>
                <a onClick={() => setOpen(false)} className="rounded-lg px-3 py-2 hover:bg-white/10" href="#shop">About Us</a>
              </div>
            </div>
          )}
        </div>
